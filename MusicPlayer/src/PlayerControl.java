...
public class PlayerControl extends BorderPane {
    ...
    public PlayerControl(final Song s) {
        ...
        duration = s.song.getMedia().getDuration();
    ...
    */
        mp.setOnReady(new Runnable() {
            public void run() {
                ...
                synchronized (mp) { //this is required since mp.setOnReady creates a new thread and our loopp  in the main thread
                    mp.notify();// the loop has to wait unitl we are able to get the media metadata thats why use .wait() and .notify() to synce the two threads(main thread and MediaPlayer thread)
                }
            }
        });
    ...
    protected void updateValues() {
        //System.out.println("ToString() of Playtime: "+playTime.toString());
        //System.out.println("ToString() of timeSlider: "+timeSlider.toString());
        //System.out.println("ToString() of volumeSlider: "+volumeSlider.toString());
        //System.out.println("ToString() of duration: "+duration.toString());
